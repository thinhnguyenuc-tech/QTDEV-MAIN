       ...
       return bluebird.try(function() {
           ...
           if (data.statusCode !== 200) {
               ...
               if (data.statusCode === 404) {
                   log.error("parseAndCheckLogin", "Got 404 error - Session may have expired or endpoint changed");
                   throw new Error("parseAndCheckLogin got status code: 404. Session may have expired. Please re-login.");
               }
