...
if (!fs.existsSync(process.cwd() + '/gojo')) {
    fs.mkdirSync(process.cwd() + '/gojo');
    fs.writeFileSync(process.cwd() + '/gojo/A_README.md', 'This folder is used by ChernobyL(NANI =)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var db = new BetterDB(process.cwd() + "/gojo/SyntheticDatabase.sqlite");
