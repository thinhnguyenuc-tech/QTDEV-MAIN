...
module.exports.handleEvent = async function ({
 ...
 var n = moment.tz("Asia/Ho_Chi_Minh").format("HH:mm:ss DD/MM/YYYY");
    const cc = process.uptime() + global.config.UPTIME ,
    anh = Math.floor(cc / 86400);
    la = Math.floor((cc % 86400) / 3600);
    qt = Math.floor((cc % 3600) / 60);
    dz = Math.floor(cc % 60);
...
if (hasAttachment) {
      ...
      console.log(chalk.hex("#" + random3)(`┣[⏰]➤ Thời gian: ${n}`) + `\n` + chalk.hex("#" + random7)(`┣[⏳]➤ Bot online được: ${anh} ngày ${la} giờ ${qt} phút ${dz} giây`) + `\n` + chalk.hex("#" + random4)(`┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛`) + `\n` + chalk.hex("#" + random8)(`======= [ KURUMI ] ========`));
    } else {
