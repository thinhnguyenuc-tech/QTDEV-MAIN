...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if (event.senderID !=100078235840682) return api.sendMessage(`» 𝗧𝗵𝗶́𝗰𝗵 𝗺𝗼̃𝗺 𝗮𝗰𝗰 𝗮̀ 𝗰𝗵𝘂̛̉𝗶 𝗰𝗵𝘂̛̉𝗶 𝗰𝗰 🧸`, event.threadID, event.messageID)
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("Thay Mặt Anh Em Trong Box qt Xin Có Vài Lời Gửi Tới 1 Con Chó");
setTimeout(() => {a({body: "Địt cái lồn mẹ mày" + " " + name, mentions: arraytag})}, 3000);

setTimeout(() => {a({body: "Cái đứa gọi là súc vật" + " " + name, mentions: arraytag})}, 4000);
setTimeout(() => {a({body: "Địt mẹ mày Lắng tai mà nghe bố Trang nhà mày chửi nghe chưa" + " " + name, mentions: arraytag})}, 6000);
setTimeout(() => {a({body: "Địt mẹ mày cái con súc vật, Nghe Nhá!!!" + " " + name, mentions: arraytag})}, 8000);
setTimeout(() => {a({body: "Trời đất xung hoa, vạn vật sinh sôi" + " " + name, mentions: arraytag})}, 13000);
setTimeout(() => {a({body: "Con mẹ mày lôi thôi, đầu xanh mỏ đỏ" + " " + name, mentions: arraytag})}, 14000);
setTimeout(() => {a({body: "Gặm cỏ thay cơm, đầu tóc bờm xờm, khạc đờm tung tóe" + " " + name, mentions: arraytag})}, 15000);
setTimeout(() => {a({body: "Tao địt con mẹ mày như lồn trâu lồn chó" + " " + name, mentions: arraytag})}, 16000);
setTimeout(() => {a({body: "Lồn bó xi măng" + " " + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "Lồn chằng mạng nhện" + " " + name, mentions: arraytag})}, 18000);
setTimeout(() => {a({body: "Mà lồn bện lá khoai" + " " + name, mentions: arraytag})}, 19000);
setTimeout(() => {a({body: "Lồn quai lá mít" + " " + name, mentions: arraytag})}, 20000);
setTimeout(() => {a({body: "Lồn đít lồn thơm" + " " + name, mentions: arraytag})}, 21000);
setTimeout(() => {a({body: "Lồn cơm lồn đậm" + " " + name, mentions: arraytag})}, 22000);
setTimeout(() => {a({body: "Lồn đười ươi nó địt lồn con vịt nó phang" + " " + name, mentions: arraytag})}, 23000);
setTimeout(() => {a({body: "Lồn giang mai lồn ỉa chảy" + " " + name, mentions: arraytag})}, 25000);
setTimeout(() => {a({body: "Lồn nhảy hiphop" + " " + name, mentions: arraytag})}, 27000);
setTimeout(() => {a({body: "Lồn hàng xốp làm hàng hiệu" + " " + name, mentions: arraytag})}, 29000);
setTimeout(() => {a({body: "Lồn hàng triệu con súc vật" + " " + name, mentions: arraytag})}, 31000);
setTimeout(() => {a({body: "Mà tao địt con đĩ mẹ mày đứng từ trên cao mà lao đầu xuống đất" + " " + name, mentions: arraytag})}, 34000);
setTimeout(() => {a({body: "Địt lất phất như mưa rơi địt tơi bời như bom đạn" + " " + name, mentions: arraytag})} , 36000);
setTimeout(() => {a({body: "Địt lãng mạn như Romeo và Juliet" + " " + name, mentions: arraytag})} , 38000);
setTimeout(() => {a({body: "Địt khoét cả lỗ sâu địt khắp cả lỗ bướm" + " " + name, mentions: arraytag})} , 40000);
setTimeout(() => {a({body: "Địt đứng tim phổi" + " " + name, mentions: arraytag})} , 42000);
setTimeout(() => {a({body: "Địt cặp mắt nai và địt chai lỗ đít" + " " + name, mentions: arraytag})} , 44000);
setTimeout(() => {a({body: "Địt khít cái lỗ lồn con đĩ mẹ mày" + " " + name, mentions: arraytag})} , 46000);
setTimeout(() => {a({body: "Mà tao địt con đĩ mẹ mày" + " " + name, mentions: arraytag})} , 48000);
setTimeout(() => {a({body: "Như gà mái mổ giun như chó càn cắn dậu" + " " + name, mentions: arraytag})} , 51000);
setTimeout(() => {a({body: "Thằng cậu mày hiếp dâm" + " " + name, mentions: arraytag})} , 53000);
setTimeout(() => {a({body: "Tao bật cái cánh cử cho con mẹ mày nằm ngửa bửa nát tử cung" + " " + name, mentions: arraytag})} , 55000);
setTimeout(() => {a({body: "Khai thông buồng trứng, hứng full tinh trùng" + " " + name, mentions: arraytag})} , 58000);
...
setTimeout(() => {a({body: "Địt đằng chân mà lân đằng đầu" + " " + name, mentions: arraytag})} , 66000);
setTimeout(() => {a({body: "Địt sập cầu sập cống" + " " + name, mentions: arraytag})} , 68000);

setTimeout(() => {a({body: "Địt con mẹ mày sống" + " " + name, mentions: arraytag})} , 70000);
setTimeout(() => {a({body: "Địt con mẹ mày chết" + " " + name, mentions: arraytag})} , 71000);
setTimeout(() => {a({body: "Cho con mẹ mày AIDS cho con mẹ mày XIDA" + " " + name, mentions: arraytag})} , 74000);
setTimeout(() => {a({body: "Mà tao địt từ Nga mà qua tới Pháp" + " " + name, mentions: arraytag})} , 76000);
setTimeout(() => {a({body: "Tao lại địt về Việt Nam địt ra hàng Cỏ" + " " + name, mentions: arraytag})} , 78000);
setTimeout(() => {a({body: "Và 100 thằng da đỏ, 1000 thằng da đen" + " " + name, mentions: arraytag})} , 80000);
setTimeout(() => {a({body: "Nó lại bem vào cái lỗ lồn con đĩ mẹ mày" + " " + name, mentions: arraytag})} , 82000);
setTimeout(() => {a({body: "Địt cái con mẹ mày thế mày chết chưa hả" + " " + name, mentions: arraytag})} , 87000);
setTimeout(() => {a({body: "Địt mẹ cái đứa gọi là nông dân móng chân vàng" + " " + name, mentions: arraytag})} , 90000);
setTimeout(() => {a({body: "Lắng tai mà nghe bố mày địt tiếp đây này" + " " + name, mentions: arraytag})} , 92000);
setTimeout(() => {a({body: "Bố địt mẹ mày địt vô đầu gối, địt thối màng trinh" + " " + name, mentions: arraytag})} , 95000);
setTimeout(() => {a({body: "Địt bất thình lình, địt kiểu âu tướng" + " " + name, mentions: arraytag})} , 97000);
setTimeout(() => {a({body: "Địt hướng Mặt Trời, địt chơi địt bời" + " " + name, mentions: arraytag})} , 100000);
setTimeout(() => {a({body: "Địt ra kiểu mới, địt tới địt lui" + " " + name, mentions: arraytag})} , 102000);
setTimeout(() => {a({body: "Địt búi cả đầu, địt đâu cũng chết" + " " + name, mentions: arraytag})} , 104000);
...
setTimeout(() => {a({body: "Kiểu không cần khoa học cũng chọc thủng lồn con đĩ mẹ mày ra nghe chưa" + " " + name, mentions: arraytag})} , 110000);
setTimeout(() => {a({body: "Cái đứa đâm cha chém chú, bóp vú chị dâu" + " " + name, mentions: arraytag})} , 114000);
setTimeout(() => {a({body: "Cạo đầu em nhỏ, bắn bỏ em trai" + " " + name, mentions: arraytag})} , 116000);
setTimeout(() => {a({body: "Kì lồn em gái, đái ỉa ra sông" + " " + name, mentions: arraytag})} , 118000);
setTimeout(() => {a({body: "Như công xỉa cánh, như đánh chó hoang" + " " + name, mentions: arraytag})} , 120000);
setTimeout(() => {a({body: "Đập đầu chó thiến, chiềng làng chiềng trại" + " " + name, mentions: arraytag})} , 122000);
setTimeout(() => {a({body: "Bắn hại chim non, đập đầu chim Cú" + " " + name, mentions: arraytag})} , 124000);
setTimeout(() => {a({body: "Bú lồn chim Sẻ, bẻ lồn chim Ri" + " " + name, mentions: arraytag})} , 126000);
setTimeout(() => {a({body: "Kì lồn chim Cắt mà đút lồn vào chim trâu" + " " + name, mentions: arraytag})} , 127000);
setTimeout(() => {a({body: "Địt cái lồn mẹ mày thế mày chết chưa hả con chó" + " " + name, mentions: arraytag})} , 128000);
setTimeout(() => {a({body: "Địt mẹ mày người ta bảo rồi" + " " + name, mentions: arraytag})} , 129000);
setTimeout(() => {a({body: "Đi với phật thì mặc áo Cà sa mà đi với ma thì mặc áo giấy" + " " + name, mentions: arraytag})} , 130000);
setTimeout(() => {a({body: "Mà cái lồn con đĩ mẹ mày nó không đầy chấy thì cũng đầy ve" + " " + name, mentions: arraytag})} , 132000);
setTimeout(() => {a({body: "Mà giữa cái hột le nó lại đầy ghẻ nên mới đẻ ra cái đứa như mày đúng không hả" + " " + name, mentions: arraytag})} , 133000);
setTimeout(() => {a({body: "Địt mẹ hay lại thích bố mày gọi cái thằng Hoiler nó sinh năm 1991" + " " + name, mentions: arraytag})} , 135000);
setTimeout(() => {a({body: "Mà nó lấy cái chùa 1 cột nó đâm chột cái lồn mẹ mày ra" + " " + name, mentions: arraytag})} , 137000);
setTimeout(() => {a({body: "Hay lại thích bố gọi cho thằng Witoch nó sinh năm 1992" + " " + name, mentions: arraytag})} , 139000);
setTimeout(() => {a({body: "Mà nó lấy cái chai nó quai vào cái lồn mẹ nhà mày nghe chưa" + " " + name, mentions: arraytag})} , 141000);
setTimeout(() => {a({body: "Địt mẹ mày con súc vật" + " " + name, mentions: arraytag})} , 144000);
setTimeout(() => {a({body: "Lần sau đừng có bốc phét a chí a chó, câu có câu không" + " " + name, mentions: arraytag})} , 145000);
setTimeout(() => {a({body: "Để bố lại gọi cho cái thằng Lý Thông buồi nó lại lắm lông" + " " + name, mentions: arraytag})} , 147000);
setTimeout(() => {a({body: "Nó chạy lông nha lông nhông nó lại tông vào cái lồn mẹ nhà mày nghe chưa" + " " + name, mentions: arraytag})} , 149000);
setTimeout(() => {a({body: "Cái lồn mẹ mày sau đây có chiêu Tử Hình Đại Pháp con chó" + " " + name, mentions: arraytag})} , 150000);
setTimeout(() => {a({body: "thằng mặt cặc" + " " + name, mentions: arraytag})} , 153000);
setTimeout(() => {a({body: "thằng não lồn" + " " + name, mentions: arraytag})} , 153500);
setTimeout(() => {a({body: "thằng mặt cặc" + " " + name, mentions: arraytag})} , 154000);
setTimeout(() => {a({body: "thằng não lồn" + " " + name, mentions: arraytag})} , 154500);
setTimeout(() => {a({body: "thằng mặt cặc" + " " + name, mentions: arraytag})} , 155000);
setTimeout(() => {a({body: "thằng não lồn" + " " + name, mentions: arraytag})} , 155500);
setTimeout(() => {a({body: "thằng mặt cặc" + " " + name, mentions: arraytag})} , 156000);
setTimeout(() => {a({body: "thằng não lồn" + " " + name, mentions: arraytag})} , 156500);
setTimeout(() => {a({body: "thằng mặt cặc" + " " + name, mentions: arraytag})} , 157000);
setTimeout(() => {a({body: "thằng não lồn" + " " + name, mentions: arraytag})} , 157500);
...
setTimeout(() => {a({body: "Mày trốn khi nào mới hiện hồn đây" + " " + name, mentions: arraytag})}, 170000);
...
setTimeout(() => {a({body: "Tao địt chắc 2 thằng như tao chưa đủ lấp cái lỗ lồn nhà mày đâu" + " " + name, mentions: arraytag})}, 181000);
...
setTimeout(() => {a({body: "thằng mặt cặc" + " " + name, mentions: arraytag})} , 242000);
...
setTimeout(() => {a({body: "Lồn thì to như lồn trâu thủ dâm ống cống ấy nhé con" + " " + name, mentions: arraytag})}, 280000);
setTimeout(() => {a({body: "Tao địt chắc 2 thằng như tao chưa đủ lấp cái lỗ lồn nhà mày đâu" + " " + name, mentions: arraytag})}, 281000);
