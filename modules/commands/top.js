...
function TX(tx, i, x) {
  return `━━━━━━━━━━━━━━━━━━\n${i >= 11 ? `→ 𝗕𝗮̣𝗻 đ𝘂̛́𝗻𝗴 𝘁𝗵𝘂̛́: ${i}\n➝ ${tx == "money" ? `𝗠𝗢𝗡𝗘𝗬: ${CC(x)} VND` : `𝗟𝗘𝗩𝗘𝗟: ${LV(x)}`}` : i >= 1 && i <= 4 ? "→ 𝗕𝗮̣𝗻 𝗵𝗶𝗲̣̂𝗻 đ𝗮𝗻𝗴 𝗰𝗼́ 𝗺𝗮̣̆𝘁 𝘁𝗿𝗼𝗻𝗴 𝗧𝗢𝗣 " : i == 0 ? "➝ 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗯𝗮̣𝗻 đ𝗮𝗻𝗴 𝗹𝗮̀ 𝗻𝗴𝘂̛𝗼̛̀𝗶 đ𝘂̛́𝗻𝗴 𝗧𝗢𝗣 đ𝗮̂̀𝘂 " : "→ 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗯𝗮̣𝗻 đ𝗮𝗻𝗴 𝗰𝗼́ 𝗺𝗮̣̆𝘁 𝘁𝗿𝗼𝗻𝗴 𝗧𝗢𝗣 10"}`
}