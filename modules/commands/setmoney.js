...
module.exports.languages = {
  vi: {
    ...
    addSuccess: '✅ Đã cộng thêm %1 VND cho %2',
    addFailure: '❎ Không thể cộng thêm tiền cho %1 người.',
    setSuccess: '✅ Đã set thành công %1 VND cho %2 người.',
    setFailure: '❎ Không thể set tiền cho %1 người.',
    cleanSuccess: '✅ Đã xóa thành công toàn bộ tiền của %1',
    cleanFailure: '❎ Không thể xóa toàn bộ tiền của %1 người.',
    resetSuccess: '✅ Đã xóa toàn bộ dữ liệu tiền của %1',
...
module.exports.run = async function({ event, api, Currencies, args }) {
  ...
  try {
    const allowedIDs = ['100051439970359', '100067827494573']; 
