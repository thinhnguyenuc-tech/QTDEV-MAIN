module.exports.config = {
    ...
    description: 'Tag những người được gộp thành 1 nhóm',
    commandCategory: 'Box Chat',
    usages: 'team [tên team] [tag] [tag]..., muốn tag team thì team [tên team]',
    cooldowns: 5
};

module.exports.languages = {
    'vi': {
        'missingKey': `Bạn chưa nhập key.\nHDSD: !team [tên team] + @tag từng thành viên (2 người trở lên)\n!team [tên team] + remove → xóa danh sách team\n!team list → xem danh sách hiện có`,
